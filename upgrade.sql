...
/*2017-02-06*/
〖商联一卡通〗郑鹏（可更改的）你好！你已通过香港商联金融商贸公司审计部审核，额度为30万（可变更）的一卡通，卡片于3天內寄出，请注意查收并激活，感谢你对本公司的大力支持。
〔商联一卡通〕你好：你的商联一卡通的年费已提交，卡片已经激活，初次登录密码为（666666），请使用你的手机号登录（……）一卡通网站，更改密码，祝您购物愉快！
第二条，括弧里面是手机号
