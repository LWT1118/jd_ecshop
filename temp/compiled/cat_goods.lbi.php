...
?>
			<a href="<?php echo $this->_var['ad']['url']; ?>" class="j_ItemInfo_tong">
				<img data-original="<?php echo $this->_var['ad']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading1.gif" alt="" height="100" width="1210">
			</a>
				...
				<div class="header left_floor">
					...
					<div class="recommend">
						<div class="words">
	    					...
	    					?>
							<?php $_from = $this->_var['child_cat']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_0_71602000_1482418771');$this->_foreach['name1'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['name1']['total'] > 0):
    foreach ($_from AS $this->_var['cat_0_71602000_1482418771']):
        $this->_foreach['name1']['iteration']++;
?>
							<?php $_from = $this->_var['cat_0_71602000_1482418771']['child']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'cat_child');$this->_foreach['name'] = array('total' => count($_from), 'iteration' => 0);
...
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad']):
        $this->_foreach['index_image']['iteration']++;
?>
						<a href="<?php echo $this->_var['ad']['url']; ?>" target="_blank" class="banner">
							<img data-original="<?php echo $this->_var['ad']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading.gif" height="297" width="240">
						</a>
						<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
						<?php endif; ?>
					</div>
...
?>
		...
		?>
								<?php $_from = $this->_var['best_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_71602000_1482418771');$this->_foreach['cat_item_goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['cat_item_goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_71602000_1482418771']):
        $this->_foreach['cat_item_goods']['iteration']++;
?>
								<div class="j_ItemInfo" id="li_<?php echo $this->_var['goods_0_71602000_1482418771']['id']; ?>" <?php if ($this->_foreach['cat_item_goods']['iteration'] % 4 == 0): ?>style="border-right: none"<?php endif; ?>>
									<div class="wrap">
										<a target="_blank" href="<?php echo $this->_var['goods_0_71602000_1482418771']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_71602000_1482418771']['name']); ?>">
											<img data-original="<?php echo $this->_var['goods_0_71602000_1482418771']['thumb']; ?>" src="themes/68ecshopcom_360buy/images/loading.gif" alt="<?php echo htmlspecialchars($this->_var['goods_0_71602000_1482418771']['name']); ?>" height="160" width="160" class="pic_img_<?php echo $this->_var['goods_0_71602000_1482418771']['id']; ?>">
										</a>
										<p class="title">
											<a target="_blank" href="<?php echo $this->_var['goods_0_71602000_1482418771']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_71602000_1482418771']['name']); ?>"><?php echo $this->_var['goods_0_71602000_1482418771']['short_style_name']; ?></a>
										</p>
										<p class="o-price"><?php echo $this->_var['goods_0_71602000_1482418771']['market_price']; ?></p>
										<p class="price">
											<span class="j_CurPrice">
												<?php if ($this->_var['goods_0_71602000_1482418771']['promote_price'] != ""): ?>
												<?php echo $this->_var['goods_0_71602000_1482418771']['promote_price']; ?>
												<?php else: ?>
												<?php echo $this->_var['goods_0_71602000_1482418771']['shop_price']; ?>
												<?php endif; ?>
											</span>
										</p>
										<a class="j_AddCart" onclick="addToCart(<?php echo $this->_var['goods_0_71602000_1482418771']['id']; ?>)" title="加入购物车"></a>
...
?>
							...
							<div class="tabs-panel tabs-hide">
								<ul>
									...
									?>
									<?php $_from = $this->_var['new_goods']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }; $this->push_vars('', 'goods_0_71702000_1482418771');$this->_foreach['goods'] = array('total' => count($_from), 'iteration' => 0);
if ($this->_foreach['goods']['total'] > 0):
    foreach ($_from AS $this->_var['goods_0_71702000_1482418771']):
        $this->_foreach['goods']['iteration']++;
?>
									<div class="j_ItemInfo" <?php if ($this->_foreach['goods']['iteration'] % 4 == 0): ?>style="border-right: none"<?php endif; ?>>
										<div class="wrap">
											<a target="_blank" href="<?php echo $this->_var['goods_0_71702000_1482418771']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_71702000_1482418771']['name']); ?>">
												<img src="<?php echo $this->_var['goods_0_71702000_1482418771']['thumb']; ?>" alt="<?php echo htmlspecialchars($this->_var['goods_0_71702000_1482418771']['name']); ?>" height="160" width="160">
											</a>
											<p class="title">
												<a target="_blank" href="<?php echo $this->_var['goods_0_71702000_1482418771']['url']; ?>" title="<?php echo htmlspecialchars($this->_var['goods_0_71702000_1482418771']['name']); ?>"><?php echo $this->_var['goods_0_71702000_1482418771']['short_style_name']; ?></a>
											</p>
											<p class="o-price"><?php echo $this->_var['goods_0_71702000_1482418771']['market_price']; ?></p>
											<p class="price">
												<span class="j_CurPrice">
													<?php if ($this->_var['goods_0_71702000_1482418771']['promote_price'] != ""): ?>
													<?php echo $this->_var['goods_0_71702000_1482418771']['promote_price']; ?>
													<?php else: ?>
													<?php echo $this->_var['goods_0_71702000_1482418771']['shop_price']; ?>
													<?php endif; ?>
												</span>
											</p>
											<a class="j_AddCart" onclick="addToCart(<?php echo $this->_var['goods_0_71702000_1482418771']['id']; ?>)" title="加入购物车"></a>
										</div>
									</div>
									<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
								</ul>
...
if ($this->_foreach['index_image']['total'] > 0):
    foreach ($_from AS $this->_var['ad']):
        $this->_foreach['index_image']['iteration']++;
?>
					<a href="<?php echo $this->_var['ad']['url']; ?>" class="j_ItemInfo">
						<img data-original="<?php echo $this->_var['ad']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading2.gif" alt="" height="278" width="150">
					</a>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
					<?php
...
?>
					<a href="<?php echo $this->_var['ad']['url']; ?>" class="j_ItemInfo">
						<img data-original="<?php echo $this->_var['ad']['image']; ?>" src="themes/68ecshopcom_360buy/images/loading2.gif" alt="" height="279" width="150">
					</a>
					<?php endforeach; endif; unset($_from); ?><?php $this->pop_vars();; ?>
				</div>
